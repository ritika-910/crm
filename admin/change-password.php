...
if (isset($_POST['change'])) {
    ...
    $res = mysqli_fetch_assoc(mysqli_query($con, "SELECT password FROM admin WHERE id='$adminId'"));
    if (!$res || $res['password'] !== $oldPass) {
        ...
        $np = mysqli_real_escape_string($con, $newPass);
        mysqli_query($con, "UPDATE admin SET password='$np' WHERE id='$adminId'");
...
<div class="page-header">
  <div class="breadcrumb-bar"><a href="home.php">Dashboard</a><span>/</span><span>Change Password</span></div>
