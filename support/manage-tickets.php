...
checkPermission(PERM_MANAGE_TICKETS);
...
<div class="page-header">
  <div class="breadcrumb-bar"><a href="dashboard.php">Dashboard</a><span>/</span><span>Manage Tickets</span></div>
    ...
    <div class="ticket-body">
      ...
      <?php if (!empty($row['admin_remark'])): ?>
        <div class="ticket-reply">
          <div class="reply-label"><i class="fa fa-reply"></i> Support Reply — <?= $row['admin_remark_date'] ?></div>
